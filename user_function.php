...
function carousel_show_favorite($db,$cus_id)
  {
	...
	$datas['contents']['contents'][$j]['body']['contents'][0]['type'] = 'image';
	$datas['contents']['contents'][$j]['body']['contents'][0]['url'] = $prod_array[$j][2];
	$datas['contents']['contents'][$j]['body']['contents'][0]['size'] = 'full';
	$datas['contents']['contents'][$j]['body']['contents'][0]['aspectRatio'] = '1.51:1';
	$datas['contents']['contents'][$j]['body']['contents'][0]['aspectMode'] = 'fit';             
	$datas['contents']['contents'][$j]['body']['contents'][1]['type'] = 'text';      
	$datas['contents']['contents'][$j]['body']['contents'][1]['text'] = $prod_array[$j][1];      
	$datas['contents']['contents'][$j]['body']['contents'][1]['size'] = 'xl';
	$datas['contents']['contents'][$j]['body']['contents'][1]['weight'] = 'bold';
	$datas['contents']['contents'][$j]['body']['contents'][1]['wrap'] = true;
	$datas['contents']['contents'][$j]['body']['contents'][2]['type'] = 'box';
	$datas['contents']['contents'][$j]['body']['contents'][2]['layout'] = 'baseline';     
	$datas['contents']['contents'][$j]['body']['contents'][2]['contents'][0]['type'] = 'text';       
	$datas['contents']['contents'][$j]['body']['contents'][2]['contents'][0]['text'] = '฿ '.$prod_array[$j][5];
	$datas['contents']['contents'][$j]['body']['contents'][2]['contents'][0]['margin'] = 'none';  
	$datas['contents']['contents'][$j]['body']['contents'][2]['contents'][1]['type'] = 'text';       
	$datas['contents']['contents'][$j]['body']['contents'][2]['contents'][1]['text'] = 'Now ฿'.$prod_array[$j][6].' !!!';            
	$datas['contents']['contents'][$j]['body']['contents'][2]['contents'][1]['size'] = 'lg';
	$datas['contents']['contents'][$j]['body']['contents'][2]['contents'][1]['weight'] = 'bold';
	$datas['contents']['contents'][$j]['body']['contents'][2]['contents'][1]['color'] = '#FF0000';    
	$datas['contents']['contents'][$j]['body']['contents'][3]['type'] = 'text';
	$datas['contents']['contents'][$j]['body']['contents'][3]['text'] = $prod_array[$j][4];     
	$datas['contents']['contents'][$j]['body']['contents'][3]['size'] = 'sm';            
	$datas['contents']['contents'][$j]['body']['contents'][3]['wrap'] = true;      
