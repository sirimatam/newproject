...
function carousel_show_favorite($db,$cus_id)
  {
	...
	$datas['contents']['contents'][$j]['header']['contents'][3]['layout'] = 'baseline';
	$datas['contents']['contents'][$j]['header']['contents'][3]['spacing'] = 'none';
	$datas['contents']['contents'][$j]['header']['contents'][3]['contents'][0]['type'] = 'text';       
	$datas['contents']['contents'][$j]['header']['contents'][3]['contents'][0]['text'] = '฿ '.$prod_array[$j][5];
	$datas['contents']['contents'][$j]['header']['contents'][3]['contents'][0]['margin'] = 'none';  
	$datas['contents']['contents'][$j]['header']['contents'][3]['contents'][1]['type'] = 'text';       
	$datas['contents']['contents'][$j]['header']['contents'][3]['contents'][1]['text'] = 'Now ฿'.$prod_array[$j][6].' !!!';            
	$datas['contents']['contents'][$j]['header']['contents'][3]['contents'][1]['size'] = 'lg';
	$datas['contents']['contents'][$j]['header']['contents'][3]['contents'][1]['weight'] = 'bold'; 
	$datas['contents']['contents'][$j]['header']['contents'][3]['contents'][1]['color'] = '#FF0000';      
