...
$richMenuId3= "richmenu-b5605d39250019a4ad9734dffc7d23ef"; //page2 old
...
$file2 = fopen('C://xampp/htdocs/image/secondpage2.png', 'r');
$size2 = filesize('C://xampp/htdocs/image/secondpage2.png');


$fildata2 = fread($file2,$size2);
$upload_pic2 = upload_richmenu($richMenuId2,$ACCESS_TOKEN,$fildata2,$file2);
file_put_contents("php://stderr", "upload pic2 success ===> ".$upload_pic2);
